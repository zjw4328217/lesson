<template>
  <div class="content">
    <div class="top">
      ...
      <el-button type="primary" style="height:32px;lien-height:32px;padding:0 10px;">
        <span class="img">
    ...
    <div class="content">
      ...
      <el-dialog title="进度跟踪" :visible.sync="dialogVisible" width="30%" :before-close="handleClose">
          <el-timeline>
            <el-timeline-item
